...
class SWRsimulationCRRA(SWRsimulation):
    """simulate retirement outcomes and evaluate CRRA utility using a risk aversion parameter
    ...
    def eval_trial(self):
        ...
        return {'exhaustion': exhaustion,
                ...
                'crra_utility': eval_crra_utility(self),
    ...
    def chart_3_lines(self, ax, optionlabel="chart_3"):
        ...
        ax.plot(portval_df.index, np.array([START_PORTVAL]*len(portval_df)), lw=2, c='black', ls='dashed', alpha=0.5)

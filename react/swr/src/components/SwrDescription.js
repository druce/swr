        ...
        <div className="container">
            <div className="row">
                <div className="col-12">
                    ...
                    <span className="font-weight-bold">Outcome:</span> Initial spending {props.start_spend}%, mean spending {props.mean_spend}% of starting portfolio, worst case {props.worst_spend}%, {props.pct_exhausted}% of retirement cohorts exhausted portfolio.
                    <br /> &nbsp; 
                    </div>
                </div>
            </div>
